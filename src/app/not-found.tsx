...
export default function NotFound() {
  return (
    <main className="mx-auto flex min-h-screen w-full max-w-3xl flex-col items-start justify-center px-5 py-16">
      ...
      <p className="mt-4 text-[var(--color-muted)]">Die angeforderte Seite existiert nicht oder wurde verschoben.</p>
